      ...
      itens: [
        {
          ...
          criticidade: 'alto',
          acao: 'Regularizar identificacao fisica e rastreabilidade do equipamento antes do uso.',
        },
        {
          subitem: 'Capacidade',
          ...
          acao: 'Bloquear imediatamente ate recompor informacao de capacidade nominal e validar com fabricante/locadora.',
        },
        {
          subitem: 'Diagramas',
          ...
          criticidade: 'alto',
          fotoObrigatoria: true,
          acao: 'Substituir/regularizar sinalizacoes obrigatorias antes da liberacao.',
        },
        {
          subitem: 'Manual',
          item: 'Manual do fabricante acessivel para consulta (impresso/digital) e aplicavel ao modelo',
          criticidade: 'alto',
          acao: 'Disponibilizar manual atualizado e orientar equipe antes da operacao.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Manter bloqueado ate execucao e aprovacao de inspecao periodica por responsavel qualificado.',
        },
        {
          subitem: 'Manutencao',
          item: 'Historico de manutencao preventiva/corretiva disponivel e atualizado (locadora/frota)',
          criticidade: 'medio',
          acao: 'Atualizar rastreabilidade de manutencao e reavaliar condicao de liberacao.',
        },
        {
          subitem: 'Operador',
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear a operacao ate substituicao por operador qualificado e autorizado.',
        },
        {
          subitem: 'Aptidao',
          item: 'Operador com ASO/apto para funcao e condicao compativel com trabalho em altura quando aplicavel',
          criticidade: 'alto',
          acao: 'Impedir a operacao para operador nao apto e comunicar SESMT/gestao.',
        },
        {
          subitem: 'AR/PT',
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Suspender a atividade e emitir AR/PT conforme procedimento antes do inicio.',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Isolar e sinalizar a area antes de iniciar qualquer movimentacao do equipamento.',
        },
        {
          subitem: 'Solo',
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear a operacao e adequar o piso/base (placas de apoio, nivelamento, alternativa de acesso).',
        },
        {
          subitem: 'Inclinacao',
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Reposicionar o equipamento em area nivelada ou utilizar solucao alternativa.',
        },
        {
          ...
          criticidade: 'alto',
          acao: 'Replanejar rota/posicionamento e designar observador quando necessario.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear a operacao e implementar controles de aproximacao (desenergizacao, distanciamento, barreiras, vigia).',
        },
        {
          subitem: 'Clima',
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Suspender operacao em condicao impeditiva e retomar apenas com condicao segura.',
        },
        {
          subitem: 'Circulacao',
          item: 'Rotas de circulacao definidas e livres (pedestres, veiculos, empilhadeiras) com controle de trafego',
          criticidade: 'alto',
          acao: 'Definir rota e controle de trafego antes de movimentar a plataforma.',
        },
        {
          subitem: 'Iluminacao',
          item: 'Iluminacao adequada para inspecao e operacao (sem pontos cegos na area de manobra)',
          criticidade: 'medio',
          acao: 'Providenciar iluminacao complementar antes da liberacao.',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          bloqueia: true,
          fotoObrigatoria: true,
          acao: 'Bloquear imediatamente e encaminhar para avaliacao tecnica/locadora.',
        },
        {
          ...
          bloqueia: true,
          fotoObrigatoria: true,
          acao: 'Bloquear o equipamento ate reparo/reinspecao do cesto/plataforma.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear imediatamente ate recomposicao/aperto das protecoes coletivas.',
        },
        {
          subitem: 'Portao',
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear ate ajuste do portao/trava/intertravamento e reinspecao funcional.',
        },
        {
          ...
          criticidade: 'alto',
          acao: 'Regularizar identificacao e condicao do ponto de ancoragem ou definir alternativa segura.',
        },
        {
          ...
          criticidade: 'alto',
          acao: 'Ajustar/manter dispositivo e instruir operador sobre risco de esmagamento.',
        },
        {
          subitem: 'Degraus/acesso',
          item: 'Degraus, apoio e pontos de pega em bom estado (sem risco de escorregamento)',
          criticidade: 'medio',
          acao: 'Corrigir acesso seguro (limpeza, substituicao, reparo) antes da liberacao.',
        },
        {
          subitem: 'Objetos soltos',
          item: 'Sem ferramentas/objetos soltos no cesto sem amarracao/organizacao (queda de objetos)',
          criticidade: 'alto',
          acao: 'Organizar e amarrar ferramentas, instalar bolsa/porta-ferramentas conforme procedimento.',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          bloqueia: true,
          fotoObrigatoria: true,
          acao: 'Bloquear imediatamente e substituir/reparar linha hidraulica antes do uso.',
        },
        {
          subitem: 'Cilindros',
          item: 'Cilindros e vedacoes sem vazamento aparente e sem danos',
          criticidade: 'alto',
          acao: 'Retirar de operacao e acionar manutencao/locadora para correcao.',
        },
        {
          subitem: 'Nivel de oleo',
          item: 'Nivel/condicao do oleo hidraulico conforme especificacao (sem contaminacao evidente)',
          criticidade: 'alto',
          acao: 'Completar/substituir oleo conforme manual e investigar origem de perda/contaminacao.',
        },
        {
          subitem: 'Travas/pinos',
          item: 'Pinos, travas e pontos de articulacao lubrificados e sem folgas anormais',
          criticidade: 'medio',
          acao: 'Lubrificar/ajustar e monitorar conforme rotina de manutencao.',
        },
        {
          subitem: 'Limpeza',
          item: 'Ausencia de oleo no piso/rodagem que gere risco de escorregamento/derrapagem',
          criticidade: 'alto',
          acao: 'Conter e limpar imediatamente, aplicar material absorvente e investigar vazamento.',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          criticidade: 'medio',
          acao: 'Programar recarga/abastecimento antes do uso ou ajustar plano operacional.',
        },
        {
          subitem: 'Cabos',
          ...
          bloqueia: true,
          fotoObrigatoria: true,
          acao: 'Bloquear imediatamente e corrigir instalacao eletrica antes da operacao.',
        },
        {
          subitem: 'Bornes',
          item: 'Bornes protegidos e bem fixados, sem oxidacao critica (bateria)',
          criticidade: 'alto',
          acao: 'Apertar/limpar bornes e substituir componentes danificados antes da liberacao.',
        },
        {
          subitem: 'Carregador',
          item: 'Carregador/cabo de recarga em bom estado e com protecao adequada (quando aplicavel)',
          criticidade: 'alto',
          acao: 'Substituir cabo/carregador danificado e garantir protecao eletrica conforme procedimento.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear imediatamente, conter vazamento e acionar manutencao antes do uso.',
        },
        {
          ...
          criticidade: 'alto',
          acao: 'Regularizar extintor/recursos antes da operacao em area com risco.',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear imediatamente e corrigir condicao de rodagem antes do uso.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear imediatamente e acionar manutencao/locadora.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear e reparar sistema de freios antes de movimentacao em qualquer area.',
        },
        {
          subitem: 'Direcao',
          item: 'Direcao responde sem travamentos e retorna conforme esperado',
          criticidade: 'alto',
          acao: 'Suspender uso ate avaliacao do sistema de direcao se houver anomalia.',
        },
        {
          subitem: 'Alarmes de movimento',
          item: 'Alarme/buzina de movimentacao funcional (quando existente)',
          criticidade: 'medio',
          acao: 'Reparar alarme e reforcar isolamento/observador ate regularizacao.',
        },
        {
          subitem: 'Calcos',
          item: 'Calcos disponiveis e aplicados quando necessario para imobilizacao (quando aplicavel)',
          criticidade: 'medio',
          acao: 'Providenciar calcos e orientar equipe sobre uso conforme condicao do piso.',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear ate reparo/substituicao e reinspecao das patolas.',
        },
        {
          subitem: 'Travas',
          item: 'Travas/pinos de seguranca presentes e funcionais (quando aplicavel)',
          criticidade: 'alto',
          acao: 'Recompor travas/pinos e reinspecionar antes da liberacao.',
        },
        {
          subitem: 'Placas de apoio',
          item: 'Placas/base de apoio usadas quando necessario (solo fragil, distribucao de carga)',
          criticidade: 'alto',
          acao: 'Aplicar placas adequadas conforme manual e condicao do piso.',
        },
        {
          subitem: 'Nivelamento',
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear operacao ate garantir nivelamento e funcionamento do indicador/sensores.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear e reparar intertravamentos antes de liberar o equipamento.',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear ate restabelecer controle no solo para resgate/operacao segura.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear ate reparo do sistema de comando e reinspecao funcional.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear imediatamente e reparar o circuito de emergencia.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear ate validar descida de emergencia e treinar equipe de apoio.',
        },
        {
          subitem: 'Seletor de controle',
          item: 'Seletor solo/cesto e chaves de habilitacao funcionais (sem mau contato)',
          criticidade: 'alto',
          acao: 'Corrigir seletor/chave e testar antes da liberacao.',
        },
        {
          subitem: 'Movimentos',
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear e acionar manutencao/locadora para diagnostico.',
        },
        {
          subitem: 'Indicadores',
          item: 'Indicadores e avisos do painel funcionais (bateria, inclinacao, sobrecarga, falhas)',
          criticidade: 'alto',
          acao: 'Regularizar indicadores/diagnostico; se indicador de seguranca estiver inoperante, bloquear.',
        ...
        },
        {
          ...
          criticidade: 'medio',
          acao: 'Reparar buzina/alerta e reforcar comunicacao por radio/observador ate regularizacao.',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear ate reparo e teste do limitador de carga/sobrecarga.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear imediatamente ate validar sensor de inclinacao e intertravamentos.',
        },
        {
      ...
      itens: [
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear a atividade ate adequacao completa do EPI/EPC conforme AR/PT.',
        },
        {
          subitem: 'Amarracao de ferramentas',
          item: 'Ferramentas e materiais amarrados/armazenados para prevenir queda de objetos',
          criticidade: 'alto',
          acao: 'Organizar e amarrar ferramentas; instalar bolsa/porta-ferramentas.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Interromper imediatamente e redefinir metodo/equipamento adequado.',
        },
        {
          subitem: 'Limites de alcance',
          item: 'Operacao dentro dos limites do fabricante (sem ultrapassar guarda-corpo, sem se projetar)',
          criticidade: 'alto',
          acao: 'Parar e reposicionar equipamento; reforcar treinamento sobre limites.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear pratica insegura e seguir restricoes do fabricante.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Interromper e replanejar a tarefa com metodo adequado (içamento, ancoragem, acesso alternativo).',
        },
        {
          subitem: 'Passageiros',
          item: 'Somente pessoas autorizadas no cesto, respeitando limite e orientacao do fabricante',
          criticidade: 'alto',
          acao: 'Ajustar equipe no cesto e respeitar limite; se excedido, bloquear.',
          observacaoObrigatoria: true,
        },
        {
          subitem: 'Observador',
          ...
          criticidade: 'medio',
          acao: 'Designar observador e definir sinais/raio de atuacao antes de movimentar.',
        },
      ],
    },
    {
      ...
      itens: [
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Bloquear ate definir plano de resgate e treinar equipe envolvida.',
        },
        {
          ...
          criticidade: 'alto',
          acao: 'Designar e orientar pessoa de apoio antes do inicio da atividade.',
        },
        {
          subitem: 'Comunicacao',
          item: 'Meio de comunicacao eficaz (radio/telefone/sinais) entre operador e apoio',
          criticidade: 'alto',
          acao: 'Definir comunicacao e testar antes de iniciar elevacao.',
        },
        {
          subitem: 'Primeiros socorros',
          item: 'Acesso a recursos de primeiros socorros e procedimento de acionamento de emergencia',
          criticidade: 'medio',
          acao: 'Garantir disponibilidade e alinhamento de acionamento (ramal, contato, rota de socorro).',
        },
      ],
    },
    {
      ...
      itens: [
        ...
        },
        {
          ...
          criticidade: 'alto',
          acao: 'Adequar local/procedimento de recarga/abastecimento e treinar equipe.',
        },
        {
          subitem: 'Registro de falhas',
          item: 'Falhas/alertas ocorridos no turno registrados e comunicados (manutencao/locadora/gestao)',
          criticidade: 'alto',
          acao: 'Registrar imediatamente e, se critico, bloquear fisicamente o equipamento.',
        },
        {
          ...
          criticidade: 'critico',
          bloqueia: true,
          acao: 'Aplicar bloqueio e identificacao visivel, segregar e impedir uso ate manutencao.',
        },
      ],
    },
  ];
