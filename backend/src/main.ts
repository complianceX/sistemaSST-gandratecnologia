...
// import { createBullBoard } from '@bull-board/api';         // TESTE
// import { BullMQAdapter } from '@bull-board/api/bullMQAdapter'; // TESTE
// import { ExpressAdapter as BullBoardExpressAdapter } from '@bull-board/express'; // TESTE
// import { getQueueToken } from '@nestjs/bullmq';             // TESTE
// import type { Queue } from 'bullmq';                        // TESTE
...
async function bootstrap() {
  ...
  // BullBoard — TESTE: comentado para isolar causa do 502
  ...
  // });
  // const bullBoardAuth: RequestHandler = ...
