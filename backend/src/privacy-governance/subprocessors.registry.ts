...
export const PRIVACY_SUBPROCESSORS: PrivacySubprocessor[] = [
  {
    ...
    purpose: 'Execucao da API, workers, processamento assíncrono e logs operacionais',
    dataCategories: ['conta', 'tenant', 'logs tecnicos', 'metadados operacionais'],
  ...
  },
  {
    ...
    transferMechanism: 'provider_terms_pending_review',
    dpaStatus: 'pending_review',
    evidenceRequired: ['DPA vigente', 'regiao do banco', 'configuracao de backup'],
  },
  {
    id: 'redis',
    ...
    dataCategories: ['identificadores de usuario', 'tenant', 'metadados de jobs'],
    sensitiveDataRisk: 'medium',
    internationalTransfer: true,
    transferMechanism: 'provider_terms_pending_review',
    dpaStatus: 'pending_review',
  ...
  },
  {
    ...
    status: 'configured_if_enabled',
    countries: ['Estados Unidos'],
    purpose: 'Geracao de respostas assistivas sobre SST com minimizacao e sanitizacao previa',
    dataCategories: ['prompts', 'contexto operacional minimizado', 'metadados de uso'],
    sensitiveDataRisk: 'high',
    internationalTransfer: true,
    transferMechanism: 'provider_terms_pending_review',
    dpaStatus: 'pending_review',
    evidenceRequired: ['DPA/API data processing terms', 'retencao do provedor', 'DPIA/RIPD de IA'],
  },
  {
    id: 'sentry',
    provider: 'Sentry',
    ...
    dataCategories: ['logs de erro', 'metadados de navegador', 'usuario pseudonimizado'],
    sensitiveDataRisk: 'medium',
    internationalTransfer: true,
    transferMechanism: 'provider_terms_pending_review',
    dpaStatus: 'pending_review',
    evidenceRequired: ['DPA vigente', 'configuracao de PII scrubbing', 'retencao de eventos'],
  },
  {
    id: 'newrelic',
    provider: 'New Relic',
    ...
    dataCategories: ['metadados tecnicos', 'rotas', 'logs/traces se habilitados'],
    sensitiveDataRisk: 'medium',
    internationalTransfer: true,
    transferMechanism: 'provider_terms_pending_review',
    dpaStatus: 'pending_review',
    evidenceRequired: ['DPA vigente', 'politica de logs', 'mascaramento de atributos'],
  },
  {
    id: 'google-calendar',
    provider: 'Google',
    ...
    transferMechanism: 'provider_terms_pending_review',
    dpaStatus: 'pending_review',
    evidenceRequired: ['base contratual Google', 'escopos OAuth', 'politica de compartilhamento'],
  },
  {
    id: 'file-storage',
    ...
    transferMechanism: 'provider_terms_pending_review',
    dpaStatus: 'pending_review',
    evidenceRequired: ['provedor real', 'regiao do bucket', 'politica de lifecycle', 'criptografia'],
  },
];
