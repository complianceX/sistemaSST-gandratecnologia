      ...
      <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between border-b px-6 py-4 bg-gray-50">
          <div>
            ...
            <p className="text-xs text-gray-500">Participante: <span className="font-bold text-amber-700">{userName}</span></p>
          </div>
          <button 
            type="button"
            onClick={onClose} 
          ...
          <div className="mb-6 flex space-x-2 rounded-lg bg-gray-100 p-1">
            <button
              ...
              className={`flex flex-1 items-center justify-center space-x-2 rounded-md py-2 text-sm font-medium transition-all ${
                activeTab === 'digital' ? 'bg-white text-amber-700 shadow-sm' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-1 items-center justify-center space-x-2 rounded-md py-2 text-sm font-medium transition-all ${
                activeTab === 'upload' ? 'bg-white text-amber-700 shadow-sm' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-1 items-center justify-center space-x-2 rounded-md py-2 text-sm font-medium transition-all ${
                activeTab === 'facial' ? 'bg-white text-amber-700 shadow-sm' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-1 items-center justify-center space-x-2 rounded-md py-2 text-sm font-medium transition-all ${
                activeTab === 'cpf_pin' ? 'bg-white text-amber-700 shadow-sm' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
                ...
                {previewImage ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full bg-amber-600 p-4 text-white shadow-lg hover:bg-amber-700 active:scale-95 transition-transform"
                      title="Capturar Foto"
                    >
          ...
          <div className="flex justify-between space-x-4">
            ...
            <div className="flex space-x-3">
              ...
              <button
                type="button"
                onClick={handleSave}
                className="flex items-center space-x-2 rounded-lg bg-amber-600 px-8 py-2 text-sm font-bold text-white shadow-lg hover:bg-amber-700 active:scale-95 transition-all"
              >
