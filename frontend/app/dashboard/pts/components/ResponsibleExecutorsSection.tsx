  ...
  return (
    <div className="ds-form-section">
      ...
      {!selectedCompanyId ? (
        ...
        <div className="rounded-lg border border-[var(--ds-color-border-default)] bg-[color:var(--ds-color-surface-muted)]/24 p-4 text-sm text-[var(--ds-color-text-primary)]">
            ...
            return (
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="truncate text-xs text-[var(--ds-color-text-primary)]">{u.email || '—'}</p>
                </div>
