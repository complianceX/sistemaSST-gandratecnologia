              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:space-x-4 sm:gap-0">
                ...
                {currentStep < 3 ? (
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex items-center justify-center space-x-2 rounded-lg bg-blue-600 px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-blue-600/20 transition-all hover:bg-blue-700 disabled:opacity-50"
                  >
                    {loading ? (
